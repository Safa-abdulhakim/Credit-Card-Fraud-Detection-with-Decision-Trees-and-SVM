...
<head>
    ...
    <style>
        body {
            ...
            min-height: 100vh;
            background: linear-gradient(135deg, #1a1f36 0%, #2d3561 50%, #667eea 100%);
            display: flex; align-items: center; justify-content: center; padding: 2rem 1rem;
        }
        .auth-card {
            width: 100%; max-width: 440px; background: #fff;
            border-radius: 1.25rem; box-shadow: 0 20px 60px rgba(0,0,0,0.3); overflow: hidden;
        }
        .auth-header {
        ...
        .form-control {
            border-radius: 0.6rem; border: 1.5px solid #e5e7eb;
            padding: 0.6rem 1rem; transition: border-color 0.2s, box-shadow 0.2s;
            font-family: 'Cairo', sans-serif;
        }
        .form-control:focus {
        ...
        .btn-primary {
            border-radius: 0.6rem; padding: 0.7rem 1.5rem;
...
<body>
    <div class="auth-card">
        <div class="auth-header">
            ...
            <h4 class="mb-1 fw-bold">Task Manager</h4>
            <p class="mb-0 opacity-75 small">نظام إدارة المهام الاحترافي</p>
        </div>
        <div class="auth-body">
            @yield('content')
        </div>
