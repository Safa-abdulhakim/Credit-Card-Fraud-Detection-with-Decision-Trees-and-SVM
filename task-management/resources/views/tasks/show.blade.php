    ...
    <div class="col-lg-8">
        <div class="d-flex align-items-center justify-content-between mb-4">
            <a href="{{ route('tasks.index') }}" class="btn btn-sm btn-outline-secondary">
                <i class="bi bi-arrow-right me-1"></i>رجوع للمهام
            </a>
        ...
        <div class="card form-card">
            ...
            <div class="card-header bg-white py-4 px-4">
                <div class="d-flex align-items-start justify-content-between">
                    <div>
                        ...
                        <div class="d-flex gap-2 flex-wrap">
                            ...
                            <span class="badge bg-{{ $task->priority_color }} fs-6">
                                <i class="bi bi-flag me-1"></i>{{ $task->priority_label }}
                            </span>
                            @if($task->isOverdue())
                    ...
                    <div class="text-muted small text-end">
                        <div><i class="bi bi-calendar-plus me-1"></i>أُنشئت {{ $task->created_at->diffForHumans() }}</div>
                        <div><i class="bi bi-pencil-square me-1"></i>آخر تعديل {{ $task->updated_at->diffForHumans() }}</div>
                    </div>
                </div>
            </div>
                ...
                <div class="row g-3">
                    <div class="col-md-4">
                        <div class="bg-light rounded-3 p-3 text-center">
                            ...
                            @if($task->due_date)
                                <div class="fw-bold {{ $task->isOverdue() ? 'text-danger' : 'text-dark' }}">
                            ...
                            @else
                                <div class="text-muted">غير محدد</div>
                            @endif
                        </div>
                    </div>
                    <div class="col-md-4">
            ...
            <div class="card-footer bg-white py-3 px-4 d-flex gap-2">
                <a href="{{ route('tasks.edit', $task) }}" class="btn btn-primary">
                    <i class="bi bi-pencil me-2"></i>تعديل المهمة
                </a>
