...
<body>
    ...
    <nav class="sidebar" id="sidebar">
        ...
        <div class="sidebar-nav">
            ...
            <a href="{{ route('doctor.appointments') }}" class="sidebar-link {{ request()->routeIs('doctor.appointments*') ? 'active' : '' }}">
                <i class="fas fa-calendar-check"></i> مواعيدي
            </a>
            <a href="{{ route('doctor.patients') }}" class="sidebar-link {{ request()->routeIs('doctor.patients*') ? 'active' : '' }}">
                <i class="fas fa-procedures"></i> مرضاي
            </a>
            <a href="{{ route('doctor.prescriptions') }}" class="sidebar-link {{ request()->routeIs('doctor.prescriptions*') ? 'active' : '' }}">
