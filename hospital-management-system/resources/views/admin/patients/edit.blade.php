...
<div class="card">
    <div class="card-header d-flex align-items-center justify-content-between">
        <h6 class="mb-0 fw-semibold"><i class="fas fa-user-edit me-2 text-primary"></i>Editing: {{ $patient->name }}</h6>
        ...
        <form action="{{ route('admin.patients.update', $patient) }}" method="POST">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <textarea name="allergies" class="form-control @error('allergies') is-invalid @enderror" rows="3" placeholder="List any known allergies...">{{ old('allergies', $patient->allergies) }}</textarea>
                    @error('allergies')<div class="invalid-feedback">{{ $message }}</div>@enderror
                </div>
                <div class="col-md-6">
                    <label class="form-label fw-semibold">Medical History</label>
                    <textarea name="medical_history" class="form-control @error('medical_history') is-invalid @enderror" rows="3" placeholder="Previous conditions, surgeries...">{{ old('medical_history', $patient->medical_history) }}</textarea>
