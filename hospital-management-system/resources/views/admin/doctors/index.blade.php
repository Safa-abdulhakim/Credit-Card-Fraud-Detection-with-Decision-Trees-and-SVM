...
@section('page-actions')
    <a href="{{ route('admin.doctors.create') }}" class="btn btn-primary"><i class="fas fa-plus me-2"></i>Add Doctor</a>
@endsection
@section('content')
<!-- Filter -->
<div class="card mb-3">
    <div class="card-body py-2">
        <form method="GET" class="row g-2 align-items-end">
            <div class="col-md-5">
                <input type="text" name="search" class="form-control form-control-sm" placeholder="Search doctor name or specialization..." value="{{ request('search') }}">
            </div>
            <div class="col-md-4">
            ...
            <div class="col-md-3">
                ...
                <a href="{{ route('admin.doctors.index') }}" class="btn btn-secondary btn-sm">Reset</a>
            </div>
        </form>
    </div>
</div>
<div class="row g-3">
    ...
    <div class="col-12 col-md-6 col-xl-4">
        <div class="card h-100">
            <div class="card-body text-center p-4">
                <div class="mb-3">
                    @if($doctor->photo)
                        <img src="{{ asset('storage/' . $doctor->photo) }}" class="rounded-circle" style="width:80px;height:80px;object-fit:cover;" alt="Doctor">
                    @else
                ...
                <div class="d-flex justify-content-center gap-2 mb-3">
                    <span class="badge bg-light text-dark"><i class="fas fa-clock me-1"></i>{{ $doctor->experience_years }} yrs</span>
    ...
    @empty
    <div class="col-12"><div class="card"><div class="card-body text-center text-muted py-5">No doctors found</div></div></div>
    @endforelse
</div>
@if($doctors->hasPages())
