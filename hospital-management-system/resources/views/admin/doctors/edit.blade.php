...
<div class="card">
    <div class="card-header d-flex align-items-center justify-content-between">
        <h6 class="mb-0 fw-semibold"><i class="fas fa-user-edit me-2 text-primary"></i>تعديل: {{ $doctor->user->name ?? 'طبيب' }}</h6>
    ...
    <div class="card-body">
        <form action="{{ route('admin.doctors.update', $doctor) }}" method="POST">
            ...
            <div class="row g-3 mb-4">
                ...
                <div class="col-md-6">
                    <label class="form-label fw-semibold">كلمة المرور الجديدة <small class="text-muted">(اتركها فارغة للاحتفاظ بالحالية)</small></label>
            ...
            <div class="row g-3">
                ...
                <div class="col-12 d-flex gap-2 mt-2">
                    <button type="submit" class="btn btn-primary"><i class="fas fa-save me-2"></i>تحديث بيانات الطبيب</button>
                    <a href="{{ route('admin.doctors.show', $doctor) }}" class="btn btn-secondary">إلغاء</a>
                </div>
            </div>
        </form>
    </div>
