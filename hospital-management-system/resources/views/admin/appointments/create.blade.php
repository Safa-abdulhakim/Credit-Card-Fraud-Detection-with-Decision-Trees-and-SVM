...
@section('content')
<div class="card">
    <div class="card-header"><h6 class="mb-0 fw-semibold"><i class="fas fa-calendar-plus me-2 text-primary"></i>Appointment Details</h6></div>
    <div class="card-body">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-4">
                    ...
                    <select name="type" class="form-select @error('type') is-invalid @enderror">
                        ...
                        <option value="routine" {{ old('type') == 'routine' ? 'selected' : '' }}>Routine Checkup</option>
                    </select>
                    @error('type')<div class="invalid-feedback">{{ $message }}</div>@enderror
                </div>
                <div class="col-12">
                    <label class="form-label fw-semibold">Reason / Chief Complaint</label>
                    <textarea name="reason" class="form-control @error('reason') is-invalid @enderror" rows="3" placeholder="Describe the reason for the appointment...">{{ old('reason') }}</textarea>
                ...
                <div class="col-12 d-flex gap-2 mt-2">
                    <button type="submit" class="btn btn-primary"><i class="fas fa-calendar-check me-2"></i>Book Appointment</button>
