...
<div class="card">
    <div class="card-header d-flex align-items-center justify-content-between">
        <h6 class="mb-0 fw-semibold"><i class="fas fa-file-medical me-2 text-primary"></i>تعديل السجل الطبي</h6>
        ...
        <form action="{{ route('admin.medical-records.update', $record) }}" method="POST">
            ...
            <div class="row g-3">
                ...
                <div class="col-12 d-flex gap-2 mt-2">
                    <button type="submit" class="btn btn-primary"><i class="fas fa-save me-2"></i>تحديث السجل</button>
                    <a href="{{ route('admin.medical-records.show', $record) }}" class="btn btn-secondary">إلغاء</a>
                </div>
            </div>
        </form>
    </div>
