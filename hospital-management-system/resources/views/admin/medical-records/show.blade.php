...
@section('page-actions')
    <div class="d-flex gap-2">
        ...
        <form action="{{ route('admin.medical-records.destroy', $record) }}" method="POST" onsubmit="return confirm('Delete this medical record?')">
            @csrf @method('DELETE')
    ...
    <div class="col-12 col-lg-8">
        ...
        <div class="card mb-3">
            <div class="card-header d-flex align-items-center justify-content-between">
                <h6 class="mb-0 fw-semibold"><i class="fas fa-file-medical me-2 text-info"></i>Visit Details</h6>
            ...
            <div class="card-body">
                <div class="row g-3">
                    @if($record->symptoms)
                    <div class="col-12">
                        <div class="fw-semibold small text-uppercase text-muted mb-2">Symptoms</div>
                        <div class="p-3 bg-light rounded">{{ $record->symptoms }}</div>
                    </div>
                    @endif
                    <div class="col-12">
                        <div class="fw-semibold small text-uppercase text-muted mb-2">Diagnosis</div>
                    ...
                    @if($record->treatment)
                    <div class="col-12">
                        <div class="fw-semibold small text-uppercase text-muted mb-2">Treatment Plan</div>
                        <div class="p-3 bg-success bg-opacity-10 rounded">{{ $record->treatment }}</div>
                    </div>
                    @endif
                    @if($record->notes)
                    <div class="col-12">
                        <div class="fw-semibold small text-uppercase text-muted mb-2">Notes</div>
                    ...
                    <div class="col-12">
                        <div class="alert alert-{{ $record->follow_up_date->isPast() ? 'danger' : 'info' }} mb-0">
                            ...
                            <strong>Follow-up scheduled:</strong> {{ $record->follow_up_date->format('l, F d, Y') }}
        ...
        <div class="card">
            <div class="card-header"><h6 class="mb-0 fw-semibold"><i class="fas fa-heartbeat me-2 text-danger"></i>Vital Signs</h6></div>
            <div class="card-body">
    ...
    <div class="col-12 col-lg-4">
        <div class="card mb-3">
            ...
            <div class="card-body">
                ...
                @endif
                <a href="{{ route('admin.patients.show', $record->patient) }}" class="btn btn-sm btn-outline-primary w-100 mt-2">View Profile</a>
            </div>
        </div>

        <div class="card">
            <div class="card-header"><h6 class="mb-0 fw-semibold"><i class="fas fa-user-md me-2 text-info"></i>Attending Doctor</h6></div>
            <div class="card-body">
                <div class="d-flex align-items-center mb-2">
                ...
                @endif
                <a href="{{ route('admin.doctors.show', $record->doctor) }}" class="btn btn-sm btn-outline-info w-100 mt-2">View Profile</a>
            </div>
        </div>
    </div>
</div>
