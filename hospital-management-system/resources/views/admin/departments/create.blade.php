...
<div class="row justify-content-center">
    <div class="col-12 col-lg-8">
        <div class="card">
            <div class="card-header"><h6 class="mb-0">Department Information</h6></div>
            <div class="card-body">
                <form action="{{ route('admin.departments.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="head_doctor" class="form-control" value="{{ old('head_doctor') }}" placeholder="Name of the head doctor">
                    </div>
                    <div class="mb-4">
